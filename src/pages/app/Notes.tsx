  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {filtered.length === 0 && <p className="text-sm text-muted-foreground">No notes available.</p>}
        {filtered.map((n) => (
          <Card key={n.id} className="border-border/60 shadow-card transition-all hover:shadow-elegant">
